...
export function MoreStatsModal(props: IProps): React.ReactElement {
  return (
    <Modal open={props.open} onClose={props.onClose}>
      <StatsTable
        rows={[
          [<>Hacking:&nbsp;</>, props.sleeve.skills.hacking, <>&nbsp;({nFormat(props.sleeve.exp.hacking)} exp)</>],
          [<>Strength:&nbsp;</>, props.sleeve.skills.strength, <>&nbsp;({nFormat(props.sleeve.exp.strength)} exp)</>],
          [<>Defense:&nbsp;</>, props.sleeve.skills.defense, <>&nbsp;({nFormat(props.sleeve.exp.defense)} exp)</>],
          [
            <>Dexterity:&nbsp;</>,
            props.sleeve.skills.dexterity,
            <>&nbsp;({nFormat(props.sleeve.exp.dexterity)} exp)</>,
          ],
          [<>Agility:&nbsp;</>, props.sleeve.skills.agility, <>&nbsp;({nFormat(props.sleeve.exp.agility)} exp)</>],
          [<>Charisma:&nbsp;</>, props.sleeve.skills.charisma, <>&nbsp;({nFormat(props.sleeve.exp.charisma)} exp)</>],
        ]}
        title="Stats:"
      />
      <br />
