...
export function IndustryOverview(props: IProps): React.ReactElement {
  ...
  return (
    <Paper>
      ...
      <StatsTable
        rows={[
          ["Awareness:", nFormat(division.awareness)],
          ["Popularity:", nFormat(division.popularity)],
        ]}
      />
        ...
        <Tooltip
          title={
            <>
              ...
              <StatsTable
                rows={[
                  ["Awareness Bonus:", "x" + nFormat(Math.pow(awarenessFac, 0.85))],
                  ["Popularity Bonus:", "x" + nFormat(Math.pow(popularityFac, 0.85))],
                  ["Ratio Multiplier:", "x" + nFormat(Math.pow(ratioFac, 0.85))],
                ]}
              />
            </>
          }
        >
          <Typography>Advertising Multiplier: x{nFormat(totalAdvertisingFac)}</Typography>
        </Tooltip>
      )}
      <br />
      <StatsTable
      ...
      <Box display="flex" alignItems="center">
        ...
        >
          <Typography>Production Multiplier: {nFormat(division.prodMult)}</Typography>
        </Tooltip>
      ...
      <Box display="flex" alignItems="center">
        ...
        >
          <Typography>Scientific Research: {nFormat(division.sciResearch)}</Typography>
        </Tooltip>
