      ...
      <TableBody>
        ...
        <TableRow>
          ...
          <TableCell align="right">
            <Typography>{nFormat(props.office.avgMor)}</Typography>
          </TableCell>
        </TableRow>
        <TableRow>
          <TableCell>
          ...
          <TableCell align="right">
            <Typography>{nFormat(props.office.avgHap)}</Typography>
          </TableCell>
        </TableRow>
        <TableRow>
          <TableCell>
          ...
          <TableCell align="right">
            <Typography>{nFormat(props.office.avgEne)}</Typography>
          </TableCell>
        </TableRow>
        <TableRow>
          <TableCell>
          ...
          <TableCell align="right">
            <Typography>{nFormat(props.office.totalExp / props.office.totalEmployees || 0)}</Typography>
          </TableCell>
        </TableRow>
        <TableRow>
          <TableCell>
        ...
        {vechain && (
          <>
            <TableRow>
              ...
              <TableCell>
                <Typography align="right">{nFormat(division.getOfficeProductivity(props.office))}</Typography>
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>
              ...
              <TableCell>
                <Typography align="right">
                  {nFormat(division.getOfficeProductivity(props.office, { forProduct: true }))}
                </Typography>
              </TableCell>
            </TableRow>
            <TableRow>
              ...
              <TableCell align="right">
                <Typography>x{nFormat(division.getBusinessFactor(props.office))}</Typography>
              </TableCell>
            </TableRow>
          </>
        )}
