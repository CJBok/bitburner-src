...
export function BribeFactionModal(props: IProps): React.ReactElement {
  ...
  function getRepText(money: number): string {
    ...
    if (isNaN(money) || money < 0) {
      ...
      return "You will gain " + nFormat(repGain(money)) + " reputation with " + selectedFaction + " with this bribe";
    }
  }
  ...
  function bribe(money: number): void {
    ...
    dialogBoxCreate(`You gained ${nFormat(rep)} reputation with ${fac.name} by bribing them.`);
