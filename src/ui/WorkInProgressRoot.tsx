...
import { formatPercent, nFormat } from "./numeralFormat";
  ...
  return [
    rate.hackExp > 0 ? (
      <StatsRow
        ...
        data={{
          content: `${nFormat(rate.hackExp * CYCLES_PER_SEC)} / sec`,
        }}
      />
    ) : (
      <></>
    ...
    rate.strExp > 0 ? (
      <StatsRow
        ...
        data={{
          content: `${nFormat(rate.strExp * CYCLES_PER_SEC)} / sec`,
        }}
      />
    ) : (
      <></>
    ...
    rate.defExp > 0 ? (
      <StatsRow
        ...
        color={Settings.theme.combat}
        data={{
          content: `${nFormat(rate.defExp * CYCLES_PER_SEC)} / sec`,
        }}
      />
    ) : (
      <></>
    ...
    rate.dexExp > 0 ? (
      <StatsRow
        ...
        color={Settings.theme.combat}
        data={{
          content: `${nFormat(rate.dexExp * CYCLES_PER_SEC)} / sec`,
        }}
      />
    ) : (
      <></>
    ...
    rate.agiExp > 0 ? (
      <StatsRow
        ...
        color={Settings.theme.combat}
        data={{
          content: `${nFormat(rate.agiExp * CYCLES_PER_SEC)} / sec`,
        }}
      />
    ) : (
      <></>
    ...
    rate.chaExp > 0 ? (
      <StatsRow
        ...
        data={{
          content: `${nFormat(rate.chaExp * CYCLES_PER_SEC)} / sec`,
        }}
      />
    ) : (
      <></>
