          ...
          <Table padding="none" size="small">
            <TableBody>
              <TableRow>
                ...
                <TableCell className={classes.noborder}>
                  <Typography>{formatInt(props.workerScript.scriptRef.threads)}</Typography>
                </TableCell>
              </TableRow>
              <TableRow>
              ...
              <TableRow>
                ...
                <TableCell className={classes.noborder} align="left">
                  <Typography>&nbsp;{nFormat(scriptRef.onlineExpGained) + " hacking exp"}</Typography>
                </TableCell>
              </TableRow>
              ...
              <TableRow>
                <TableCell className={classes.noborder} colSpan={1} />
                <TableCell className={classes.noborder} align="left">
                  <Typography>&nbsp;{nFormat(scriptRef.offlineExpGained) + " hacking exp"}</Typography>
                </TableCell>
              </TableRow>
            </TableBody>
          </Table>
