    ...
    if (!this.singularity) {
      dialogBoxCreate(
        <>
          ...
          {nFormat(this.earnings.hackExp)} hacking exp <br />
          {nFormat(this.earnings.strExp)} strength exp <br />
          {nFormat(this.earnings.defExp)} defense exp <br />
          {nFormat(this.earnings.dexExp)} dexterity exp <br />
          {nFormat(this.earnings.agiExp)} agility exp <br />
          {nFormat(this.earnings.chaExp)} charisma exp
          <br />
        </>,
      );
    }
